...
public class SearchTestingSitePage extends javax.swing.JPanel {
    ...
    {
        String id = testingSite.getId();
        idTextField.setText(id);
        
        String name = testingSite.getName();
        ...
        double latitude = testingSite.getAddress().getLatitude();
        latitudeTextField.setText(String.valueOf(latitude));
        
        double longitude = testingSite.getAddress().getLongitude();
        ...
        String suburb = testingSite.getAddress().getSuburb();
        suburbTextField.setText(suburb);
        
        String state = testingSite.getAddress().getState();
        stateTextField.setText(state);
        
        String postcode = testingSite.getAddress().getPostcode();
        postcodeTextField.setText(postcode);
        
        String street = testingSite.getAddress().getStreet();
        streetTextField.setText(street);

        String street2 = testingSite.getAddress().getStreet2();
        street2TextField.setText((street2 == null) ? (NOT_AVAILABLE) : (street2));

        boolean onSiteBookingStatus = testingSite.getAdditionalInfo().getOnSiteBooking();
        onSiteBookingTextField.setText(testingSite.getAdditionalInfo().yesOrNo(onSiteBookingStatus));
        
        boolean onSiteTestingStatus = testingSite.getAdditionalInfo().getOnSiteTesting();
        onSiteTestingTextField.setText(testingSite.getAdditionalInfo().yesOrNo(onSiteTestingStatus));
        
        String openingTime = testingSite.getAdditionalInfo().getOpeningTime();
        openingTimeTextField.setText(openingTime);
        
        String closingTime = testingSite.getAdditionalInfo().getClosingTime();
        closingTimeTextField.setText(closingTime);
        
        openOrClosedTextField.setText(checkOpenOrClosed(openingTime, closingTime));
    }
